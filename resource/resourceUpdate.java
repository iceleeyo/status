...
public class resourceUpdate {
	...
	private static List<String> getLoginMonetid(Date stime){
		...
		try{
			...
			String cmd = "grep Action=ResourceFile /var/log/gamefeedback/gameServerSys.log."+date+"*|awk '{print $13}'|sort -b|uniq -c|sed -e 's/[]]//g'|sed -e 's/[[]//g'|awk '{print $2}'";
	...
	private static List<String> getUpdateResourceMonetid(Date stime){
		...
		try{
			List<String> list = new ArrayList<String>();
				...
				String cmd = "grep Action=ResourceFile /var/log/gamefeedback/gameServerSys.log."+date+"*|grep -v  ResourceNumber=0|awk '{print $13}'|sort -b|uniq -c|sed -e 's/[]]//g'|sed -e 's/[[]//g'|awk '{print $2}'";
				String []cmdArray = new String[]{ "/bin/sh", "-c", cmd};
	...
	private static List<String> getUpdateResourceSuccessMonetid(Date stime){
		...
		try{
			List<String> list = new ArrayList<String>();
				...
				String cmd = "grep Action=UpdateResourceFile /var/log/gamefeedback/gameServerSys.log."+date+"*|grep -v  ResourceNumber=0|awk '{print $13}'|sort -b|uniq -c|sed -e 's/[]]//g'|sed -e 's/[[]//g'|awk '{print $2}'";
				String []cmdArray = new String[]{ "/bin/sh", "-c", cmd};
	...
	private static List<String> getLoginSuccessMonetid(Date stime){
		...
		try{
			List<String> list = new ArrayList<String>();
				...
				String cmd = "grep -v Realm.QueryAction /home/mozat/morange/oapro/OceanAgelogs/newOA_Request.log."+date+"*|awk '{print $8}'|sort -u ";
				String []cmdArray = new String[]{ "/bin/sh", "-c", cmd};
